...
def twobody_pics():
    ...
    evalset = torch.load("res_twobody/eval.pt").cpu()
    print(evalset.shape)
    eval=evalset[:,0,:,:].cpu()
    ...
    modelODE = torch.load("res_twobody/ODEmodel.pt").cpu()
    print(modelODE) 
    ode_eval = odeint(modelODE,eval[0,:,:],t,method="rk4").cpu()
    print(ode_eval.shape)
    H_ode = datamaker.hamiltonian(ode_eval).cpu()
    print(H_ode.shape)
    
    modelMLP = torch.load("res_twobody/MLPmodel.pt").cpu()
    print(modelMLP) 
    mlp_eval = DEVICETensor(len(t),1,8).cpu()
    mlp_eval[0,:,:]= eval[0,:,:].cpu()
    for i in range(1,len(t)):
        mlp_eval[i,:,:] = modelMLP(mlp_eval[i-1,:,:]).cpu()
    print(mlp_eval.shape)
    H_mlp = datamaker.hamiltonian(mlp_eval).cpu()
    print(H_mlp.shape)
    
    modelGRU = torch.load("res_twobody/GRUmodel.pt").cpu()
    print(modelGRU) 
    gru_eval = modelGRU(eval.squeeze()[0,:].reshape(1,-1),t)
    print(ode_eval.shape)
    H_gru = datamaker.hamiltonian(gru_eval).cpu()
    ...
    modelRNN= torch.load("res_twobody/RNNmodel.pt").cpu()
    print(modelRNN) 
    rnn_eval = modelRNN(eval.squeeze()[0,:].reshape(1,-1),t)
    print(rnn_eval.shape)
    H_rnn = datamaker.hamiltonian(rnn_eval).cpu()
    ...
    modelGRE= torch.load("res_twobody/GREmodel.pt").cpu()
    print(modelGRE) 
    gre_eval = modelGRE(eval.squeeze()[0,:].reshape(1,-1),t)
    print(gre_eval.shape)
    H_gre = datamaker.hamiltonian(gre_eval).cpu()
    ...
    modelRNE= torch.load("res_twobody/RNEmodel.pt").cpu()
    print(modelRNE) 
    rne_eval = modelRNE(eval.squeeze()[0,:].reshape(1,-1),t)
    print(rne_eval.shape)
    H_rne = datamaker.hamiltonian(rne_eval).cpu()
...
def threebody_pics():
    ...
    evalset = torch.load("res_threebody/eval.pt").cpu()
    ...
    modelODE = torch.load("res_threebody/ODEmodel.pt").cpu()
    print(modelODE) 
    ode_eval = odeint(modelODE,eval[0,:,:],t,method="rk4").cpu()
    print(ode_eval.shape)
    H_ode = datamaker.hamiltonian(ode_eval).cpu()
    ...
    modelMLP = torch.load("res_threebody/MLPmodel.pt").cpu()
    print(modelMLP) 
    ...
    modelGRU = torch.load("res_threebody/GRUmodel.pt").cpu()
    print(modelGRU) 
    gru_eval = modelGRU(eval.squeeze()[0,:].reshape(1,-1),t)
    print(ode_eval.shape)
    H_gru = datamaker.hamiltonian(gru_eval).cpu()
    ...
    modelRNN= torch.load("res_threebody/RNNmodel.pt").cpu()
    print(modelRNN) 
    rnn_eval = modelRNN(eval.squeeze()[0,:].reshape(1,-1),t)
    print(rnn_eval.shape)
    H_rnn = datamaker.hamiltonian(rnn_eval).cpu()
    ...
    modelGRE= torch.load("res_threebody/GREmodel.pt").cpu()
    print(modelGRE) 
    gre_eval = modelGRE(eval.squeeze()[0,:].reshape(1,-1),t)
    print(gre_eval.shape)
    H_gre = datamaker.hamiltonian(gre_eval).cpu()
    ...
    modelRNE= torch.load("res_threebody/RNEmodel.pt").cpu()
    print(modelRNE) 
    rne_eval = modelRNE(eval.squeeze()[0,:].reshape(1,-1),t)
    print(rne_eval.shape)
    H_rne = datamaker.hamiltonian(rne_eval).cpu()
